...
function serve(done) {
  ...
  gulp.watch(`${paths.scss}/**/*.scss`, gulp.series(styles, minifyStyles, cssReset, minifyCssReset));
...
// Build task
const build = gulp.series(clean, gulp.parallel(html, gulp.series(styles, minifyStyles), gulp.series(cssReset, minifyCssReset), vendors, scripts, images));
